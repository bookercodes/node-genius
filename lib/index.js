...
function Genius(accessToken) {
   ...
   * @param  {Object}   options      The possible options e.g. text_format
   * @param  {Function} callback     The function to call once the annotation is available.
   ...
   * @param  {Function} callback   The function to call once the annotation has been created.
   * @see https://docs.genius.com/#annotations-h2
   * @example
   * createAnnotation({
   *   "annotation": {
   ...
   * @param  {String}   annotationId The annotation's id.
   * @param  {Function} callback     The function to call once the annotation has been deleted.
   * @see https://docs.genius.com/#annotations-h2
   * @example
   ...
   * @param  {[type]}   annotationId The annotation's id.
   * @param  {Function} callback     The function to call once the annotation has been upvoted.
  *  @see https://docs.genius.com/#annotations-h2
   * @example
   ...
   * @param  {[type]}   annotationId The annotation's id.
   * @param  {Function} callback     The function to call once the annotation has been unvoted.
   * @see https://docs.genius.com/#annotations-h2
   * @example
   ...
   * @param  {[type]}   annotationId The annotation's id.
   * @param  {Function} callback     The function to call once the annotation has been downvoted.
   * @see https://docs.genius.com/#annotations-h2
   * @example
   ...
   * @param  {Object}   options  The possible options e.g. text_format
   * @param  {Function} callback The function to call once information about the user is available.
